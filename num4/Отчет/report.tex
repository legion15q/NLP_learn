...
\end{cases}$$
$$
P(Q|d_1) = \bigl( (1 - \lambda) \dfrac{5}{14} + \lambda \dfrac{1}{4} \bigl ) \cdot \bigl ( (1 - \lambda) \dfrac{5}{14} + \lambda \dfrac{1}{4} \bigl ),
$$
...
$$(d_4, d_2, d_3, d_1), \quad (\lambda = 0.5),$$
$$(d_4, d_1, d_2, d_3), \quad (\lambda = 0.9).$$ В первом случае, самым релевантным документом выступает $d_4$, во втором -- $d_4$. 
 \par Полный ход вычислений доступен по ссылке:\\ \url{https://github.com/legion15q/sem2/blob/master/num4/%D0%9E%D1%82%D1%87%D0%B5%D1%82/UpEmkFkQ0UU.jpg}
\end{document}