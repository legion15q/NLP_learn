...
\begin{equation*}
\begin{aligned}
\text {Macro}F_{1}=\frac{F_{1 \text {score }}+Pr+Rec}{3}  = \text{(Среднее арифмитическое)} = \\ = 
...
\end{equation*}
\begin{equation*}
\text {Macro}F_{1}=\dfrac{F_{1\text {score}} + Pr+R e c}{3}=\dfrac{\frac{2}{3}+\frac{3}{4}+\frac{3}{5}}{3}=\dfrac{7}{10}
=0,7
\end{equation*}
\begin{equation*}
...
\begin{equation*}
\begin{aligned}
\text {MicroPrecision}=\frac{T P_{1}+TP_{2}}{T P_{1}+TP_{2}+F P_{1}+FD_{2}}  = & \dfrac{50+30}{50+30+50+10} =  \\
=\frac{8}{14} =\frac{4}{7}=0,57
\end{aligned}
\end{equation*}
\begin{equation*}
\begin{aligned}
\text {MicroRecall}=\frac{T P_{1}+TP_{2}}{T P_{1}+TD_{2}+F N_{1}+F N_{2}}=\dfrac{50+30}{50+30+10+50}= \\ = \text {MicroPrecision} = 0,57 = \text {Micro}F_1
\end{aligned}
\end{equation*}
\subsection{Задача 2}
\begin{equation*}
...
\begin{equation*}
\begin{array}{l}
\arg \max \left\{P(\tilde{C}_{1}), P(\tilde{C}_{2})\right\}=2 \Rightarrow 
D_4\left(x_{1}, x_{4}, x_{5}\right): C_{2}
\end{array}
\end{equation*}
\end{document}